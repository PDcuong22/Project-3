  ...
  <body class="noselect" align="center" style="background-color:white">
    <table id="mainTable" style="width:400px;margin:auto;table-layout:fixed" CELLSPACING=10>
      ...
      <tr>
        ...
        <td colspan=2>
         <div class="slidecontainer">
            <input type="range" min="0" max="200" value="150" class="slider" id="Speed" oninput='sendButtonInput("Speed",value)'>
          </div>
        </td>
      </tr>        
      <tr>
      ...
      <tr>
        ...
        <td colspan=2>
          <div class="slidecontainer">
            <input type="range" min="0" max="150" value="90" class="slider" id="Tilt" oninput='sendButtonInput("Tilt",value)'>
          </div>
        </td>   
      </tr>      
    </table>
